...
# Team ID:			[ GG_1949 ]
# Author List:		[ Ayush Karapagale, Akshit, Gangwar, Sparsh Gautam, Prakhar Shukla ]
# Filename:			Task_2D.py
...
def read_csv(csv_name):
    ...
    #lat_lon[header[0].encode()] = [header[1].encode(), header[2].encode()]
    print(lat_lon)
